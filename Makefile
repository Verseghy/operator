...
# verseghy.net/operator-bundle:$VERSION and verseghy.net/operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/verseghy/operator
...
.PHONY: all
all: docker-build docker-push bundle bundle-build bundle-push
...
catalog-build: opm ## Build a catalog image.
	$(OPM) index add --container-tool podan --mode semver --tag $(CATALOG_IMG) --bundles $(BUNDLE_IMGS) $(FROM_INDEX_OPT)
